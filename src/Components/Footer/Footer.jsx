...
function Footer() {
  ...
  return (
    <footer class="w-full relative">
      <div className='fixed z-20 bottom-10 right-10 p-4 border-0 w-14 h-14 rounded-full shadow-md bg-black hover:bg-gray-700 text-white text-lg font-semibold transition-colors duration-300'>
      ...
      <div class="mx-auto px-4 sm:px-6 lg:px-8">
        <div class="pt-14 grid grid-cols-12 gap-x-5 gap-y-8">
          <div class="col-span-full xl:col-span-3 relative bg-gradient-to-tr from-slate-200 to-gray-300 rounded-2xl gap-12 p-6 xl:w-72 h-96 flex flex-col justify-center items-center">
            <a href="/" class="flex justify-center lg:justify-start">
              <img
                src="/images/logo/arcon_logo.png"
                alt="Logo"
                className="w-40 h-20 object-contain"
              />
            </a>
            <hr className='border-0.5 h-1 w-1/2 bg-black' />

            <p class="text-center text-gray-800">Founded in Mumbai in 2009, Arcon has grown to become one of India's leading construction company.</p>
          ...
          {/* Quick links */}
          <div class="block xl:pt-16 col-span-full min-[500px]:col-span-6 md:col-span-4 xl:col-span-3">
            <h4 class="mx-auto  text-lg text-gray-900 font-bold mb-3 text-center xl:text-left">Quick Links</h4>
            <hr className="mb-3 border-0.5 h-1 w-1/3 rounded-lg bg-black mx-auto md:mx-0" />
          ...
          {/* Google Map */}
          <div class="block xl:pt-16 col-span-full md:col-span-4 xl:col-span-3">
          ...
          {/* Get in touch */}
          <div class="block text-center xl:text-left xl:pt-16 col-span-full min-[500px]:col-span-6 md:col-span-4 xl:col-span-3 xl:pl-5">
            <h4 class="text-lg text-gray-900 font-bold mb-2">Get In Touch</h4>
            <hr className="mb-3 border-0.5 h-1 w-1/3 rounded-lg bg-black mx-auto md:mx-0" />
      ...
      <div class="py-6 bg-black text-white">
        <div class="flex items-center justify-center">
          <span class="text-md">Copyright @{new Date().getFullYear()} All Right Reserved  by <a href="/" className=''>Arcon Associates</a></span>
        </div>
      </div>
