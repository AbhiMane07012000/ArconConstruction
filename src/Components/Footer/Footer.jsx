  ...
  return (
    <>
      <footer className="lg:h-[20vh] relative flex flex-col justify-center items-center my-5 border-t-[1px] border-slate-300  ">
        ...
        >
          <div className="absolute flex bottom-1 lg:bottom-5 h-10 w-10 lg:h-auto lg:w-auto items-center justify-center right-2 lg:right-10 bg-slate-400 rounded-full ">
            <svg
              width="64px"
              height="64px"
