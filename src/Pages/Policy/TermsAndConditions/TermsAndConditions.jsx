...
const TermsAndConditions = () => {
  return (
    <div className="h-[60vh] md:h-full lg:h-[234vh] px-4 pt-20 lg:pt-20 lg:px-40 ">
      <h2 className="text-2xl font-medium">Terms and Conditions</h2>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div>
          <h3 className=" pt-5 text-md font-medium">Conflict of Terms</h3>
        <p className="py-2">If you have any queries or concerns, please connect with us:</p>
